...
class Way {
 ...
 public:
  ...
  /**
   * @brief Copy constructor. Explicitly defined because \a closestToCarElem_
   * is an iterator into \a path_, copying it verbatim would leave it pointing
   * into the source Way's list.
   *
   * @param[in] way
   */
  Way(const Way &way);
